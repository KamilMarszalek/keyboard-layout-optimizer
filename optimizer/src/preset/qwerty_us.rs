...
/// Base symbols in QWERTY US key order, row by row from the number row to the bottom row.
#[rustfmt::skip]
...
/// Returns a ready-to-use QWERTY US keyboard preset combining standard geometry, modifier, and layout.
